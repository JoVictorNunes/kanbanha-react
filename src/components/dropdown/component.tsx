    ...
    <DropdownMenu.Root>
      <DropdownMenu.Trigger asChild>
        {children ? (
          ...
          <button className="outline-none border-none bg-transparent p-2 rounded-full hover:bg-gray-200 h-fit focus:shadow-[0px_0px_0px_2px] focus:shadow-blue-600">
            <svg
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          side={side}
          className="bg-white min-w-[220px] shadow shadow-gray-400 rounded overflow-hidden"
        >
          {options.map((option) => (
            <DropdownMenu.Item
